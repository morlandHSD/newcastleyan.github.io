;(function () {
	...
	var clickMenu = function() {
		...
		$('#navbar a:not([class="external"])').click(function(event){
		    ...
		    if ( navbar.is(':visible')) {
		    	...
		    	$('.js-template-nav-toggle').removeClass('active');
		    }
	...
	var windowScroll = function() {
		...
		$(window).scroll(function(event){
			...
			if ( scrlTop > 120 && scrlTop <= 2000 ) {
				header.addClass('navbar-fixed-top template-animated slideInDown default-padding');
			} else if ( scrlTop <= 120) {
				if ( header.hasClass('navbar-fixed-top') ) {
					header.addClass('navbar-fixed-top template-animated slideOutUp');
					setTimeout(function(){
						header.removeClass('navbar-fixed-top template-animated slideInDown slideOutUp default-padding');
					}, 100 );
				}
			} 
	...
	var homeAnimate = function() {
		if ( $('#template-home').length > 0 ) {	
			...
			$('#template-home').waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {


					setTimeout(function() {
						$('#template-home .to-animate').each(function( k ) {
							var el = $(this);
	...
	var testimonyAnimate = function() {
		var testimony = $('#template-testimony');
